  ...
  return (
    <>
      ...
      <div className="p-2 bg-black bg-[url('/images/contact-bg.webp')] bg-no-repeat bg-cover w-full h-[calc(100%-44px)] flex-col md:flex items-center justify-center">
        <h1 className="transition-all py-8 2xl:absolute 2xl:bottom-24 2xl:left-24 text-center text-2xl text-white md:text-5xl font-bold tracking-widest md:relative md:bottom-40 ">
        ...
        {messageSending ? (
          ...
          >
            <p hidden>
              <label htmlFor="bot">
                Don’t fill this out:{' '}
                <input name="bot" onChange={handleChange} />
              </label>
            </p>
