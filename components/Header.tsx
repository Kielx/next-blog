    ...
    <>
      <div className="mobileNavbar flex h-11 w-full flex-wrap bg-[#2C2C2C] lg:hidden">
        ...
        <div
          ...
          }  mobileMenu  transition-[max-height opacity] z-20 flex w-full flex-col items-start  justify-end divide-y bg-[#2C2C2C] px-10 py-4 text-lg font-thin text-[#EEEEEE] duration-[150ms]`}
        >
      ...
      <div className="desktopNavbar hidden h-11 w-full place-content-around items-center bg-[#2C2C2C] px-4 lg:flex lg:px-20 ">
        <div className="flex w-full max-w-[1600px] items-center">
          ...
          <div className="desktopMenu flex h-full w-1/2 items-center justify-end gap-8 text-sm font-thin text-[#EEEEEE]">
            {mapNavItems(navItems)}
          </div>
