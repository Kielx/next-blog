...
date: '2022-02-01'
excerpt: Terminal styled portfolio. Powered by Gatsby, lightning-fast, generating pages from Markdown files, with terminal windows created as Winbox.js instances.
